...
const TodoImplemented: React.FC = () => {
  const classes = useStyles();

  return (
    <GenericTemplate title="未実施のTODO">
      <TableContainer component={Paper}>
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell>作業者</TableCell>
              <TableCell align="right">作業内容</TableCell>
              <TableCell align="right">備考</TableCell>
              <TableCell align="right">実施時間</TableCell>
              <TableCell align="right">終了日</TableCell>
...
export default TodoImplemented;